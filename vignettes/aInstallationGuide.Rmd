...
Download the tar.gz file from [this dropbox link](https://www.dropbox.com/scl/fi/rh5x0todkjlcz5s7zpe5f/safestats_0.8.8.tar.gz?rlkey=rvybc4uhgclku0g3siu9vt1zz&dl=0) and save it to a folder that you can easily find. 
...
plot(xDomain, treatmentPopulation,
...
oldPar <- safestats::setSafeStatsPlotOptionsAndReturnOldOnes()
plot(xDomain, differencePopulationAlt,
  type = "l", lwd = 2,
...
plot(resultObj)
plot(resultObj, wantConfSeqPlot = TRUE)
```
