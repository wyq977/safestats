...
oldPar <- setSafeStatsPlotOptionsAndReturnOldOnes()
plot(1:n1, 100 * subjectiveBfValueFalseRejects,
  type = "l",
  xlab = "n", ylab = "False positive rate (%)",
  lwd = 2, col = bayesColours[1], ylim = c(0, 20)
)

lines(1:n1, 100 * subjectiveBfValueFalseRejects30,
  lwd = 2,
...
oldPar <- setSafeStatsPlotOptionsAndReturnOldOnes()
plot(1:n1, allBfValues[someIndex, ],
  type = "l", lwd = 2,
...
result <- safeZTest(dataGroup1, dataGroup2[1:i],
  designObj = designObj
)
plot(result)
```
